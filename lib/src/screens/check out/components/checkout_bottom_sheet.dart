            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Obx(
                    () => MyTextWidget(
                        title:
                            "\$ ${cartController2.totalAmount.value.toStringAsFixed(2).toString()}",
              ...
              SizedBox(
                ...
                child: MyElevatedButtonWidget(
                    text: "Pay Now",
                    ontap: () async {
                      await cartProductRF.doc(authCurrentUser).delete();
                      Get.offAllNamed("/navbar");

                      Fluttertoast.showToast(msg: "Checkout Successfully");
                    }),
              ),
            ],
          ),
